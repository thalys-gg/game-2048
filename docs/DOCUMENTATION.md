...
| --------------------- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **High-level**        | What is this, how is it wired, _why these choices_ | [`AGENTS.md`](../AGENTS.md) (brief entry), [`docs/architecture.md`](architecture.md) (diagram), [`docs/decisions/`](decisions/) (ADRs for the _why_) |

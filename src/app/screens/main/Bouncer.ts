import type { ScreenMain } from '@/screens/main/ScreenMain.ts'
import { randomFloat } from '∆/utils/random'
import { waitFor } from '∆/utils/waitFor'
import { animate } from 'motion'
import { Logo } from '@/screens/main/Logo'
import { DIRECTION } from '@/screens/main/types'
...
export class Bouncer {
  ...
  public async show (screen: ScreenMain): Promise<void> {
    this.screen = screen

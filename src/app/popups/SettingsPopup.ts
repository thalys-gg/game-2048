...
export class SettingsPopup extends Container {
  ...
  /** List that organizes the UI components */
  private list: List
  ...
  constructor () {
    super()
    this.label = 'SettingsPopup'

    this.bg = create.popup.Settings.bg()
    this.addChild(this.bg)

    this.panel = new Container()
    this.addChild(this.panel)

    this.panelBase = new RoundedBox({ height: 525 })
    ...
    this.list = new List({ type: 'vertical', elementsMargin: 10 })
    this.list.x = -140
    this.list.y = -80
